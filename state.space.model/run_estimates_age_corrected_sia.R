...
###load-data
###################################################
allcases<-read.csv("input-cases.csv",header=T,row.names=1) #Done
allbirths<-read.csv("input-births.csv",header=T,row.names=1) #Done
alldeaths<-read.csv("input-deaths_5.csv",header=T,row.names=1) #Done
allpop<-read.csv("input-populations.csv",header=T,row.names=1) #Done
allpop$X2017= as.numeric(as.character(allpop$X2017))
allmcv1<-read.csv("input-mcv1.csv",header=T,row.names=1) #Done
mcv1.12mo<-read.csv("input-mcv1vaxeff.csv",header=T,row.names=1) #Done
allmcv2<-read.csv("input-mcv2.csv",header=T,row.names=1) #Done
allsia<-read.csv("output-sia_age_corrected.csv",header=T,row.names=1) 
first.surveillance<-unlist(read.csv("input-first.surveillance.csv",header=T,row.names=1)[,2]) #Done
outbreaks<-read.csv("output-outbreaks.csv",header=T,row.names=1)  #Done
###################################################
### estimate-incidence
###################################################
ignore.codes<-read.csv("input-ignore.indices.csv",header=T) #Done
...
### load-mortality-data
###################################################
agedist<-read.csv("input-agedist_pred.csv",header=T)  #Done
agedist.se<-read.csv("input-agedist_se.csv",header=T) #Done
cfr1<-read.csv("input-cfr1-constant.csv",header=T,row.names=1) #Done
cfr2<-read.csv("input-cfr2-constant.csv",header=T,row.names=1) #Done
cfr3<-read.csv("input-cfr3-constant.csv",header=T,row.names=1) #Done
mcv_5<-read.csv("input-mcv1x5yrs.csv",header=T,row.names=1) #Done
codes<-read.csv("input-gbd_Region.csv",header=T,row.names=1) #Done
###################################################
### estimate-mortality
###################################################
...
###################################################
igme<-read.csv("input-igme.csv",header=T,row.names=1)[,1:(dim(allcases)[2]-1)] #Done
