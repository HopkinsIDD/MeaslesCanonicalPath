estimate_mortality<-function(binary.file="output-mortality.Rdat",incidence_workspace="output-incidence.Rdat",agedist,agedist.se,cfr1,cfr2,cfr3,mcv_5,codes,ignore.indices=NA,ITER=10000,lb=0.025,ub=0.975,display=T){
#browser()
