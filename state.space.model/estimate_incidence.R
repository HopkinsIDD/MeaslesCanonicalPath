incidence_estimate<-function(binary.file="state.space.model/output-incidence.Rdat",allcases,allbirths,
...
write.csv(PAR,file="state.space.model/output-pars.csv",row.name=ISOcodes)
write.csv(CASES,file="state.space.model/output-estimated_incidence.csv",row.name=ISOcodes)
write.csv(CIL,file="state.space.model/output-lb_incidence.csv",row.names=ISOcodes)
write.csv(CIU,file="state.space.model/output-ub_incidence.csv",row.names=ISOcodes)
write.csv(LIKE,file="state.space.model/output-like.csv",row.name=ISOcodes)
write.csv(SUS,file="state.space.model/output-sus",row.name=ISOcodes)
